module.tx_imagetools_module1 {
    settings {
        # cat=tx_imagetools_module1/settings/a; type=string; label=Add Tinify-Key: Add API-Key for the Tinify-API
        tinifyKey = key
        # cat=tx_imagetools_module1/settings/b; type=int; label=Width: Set the width for all images
        widthForAll = -1
